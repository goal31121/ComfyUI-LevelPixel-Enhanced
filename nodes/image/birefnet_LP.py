...
class ImageRemoveBackgroundBiRefNet:
    def __init__(self):
...
NODE_CLASS_MAPPINGS = {
    "ImageRemoveBackgroundBiRefNet|LP": ImageRemoveBackgroundBiRefNet
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "ImageRemoveBackgroundBiRefNet|LP": "Image Remove Background (BiRefNet) [LP]",
}